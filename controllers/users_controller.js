var cliente = require('../helpers/rest_client');
...
exports.new_user = function(request, response) {
   
    response.render('users_registration',{estados})
};

exports.save_user = function(req, response) {
    console.log('olha o post!')
